export default {
  en: {
    ...
    coursesCompleted: "Course Completed",
    noCoursesCompleted: "No courses completed yet",
    registeredDateUnavailable: "Unavailable",
  },
  fr: {
  ...
  ro: {
    ...
    COURSES: "CURSURI",
    RESOURCES: "RESURSE",
    completeLesson: "Finalizează lecția",
    lessonCompleted: "Lecție finalizată",
    completedCount: "{{completed}} / {{total}} finalizate",
